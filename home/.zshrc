...
# note, that sourcing this after p10k prompt removes the color from fastfetch, but no other option as ohmyzsh overrites several aliases
source ${HOME}/.profile
